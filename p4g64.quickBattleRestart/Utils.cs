...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Quick Battle Restart] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Quick Battle Restart] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Quick Battle Restart] {message}", System.Drawing.Color.Red);
    }
